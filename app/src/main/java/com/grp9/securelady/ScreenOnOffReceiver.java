            ...
            public void onComplete(@NonNull Task<Location> task) {
                ...
                if (location != null) {
                    ...
                    try {
                        ...
                        Message += "\nOpen Maps: http://maps.google.com/maps?q="
                ...
                if (!Value1.equals ("") || !Value2.equals ("") || !Value3.equals ("") || !Value4.equals ("")) {
                    if (!Value1.equals ("")) {
                        sendSMS(phoneNumber1, Message, context);
                    }

                    if (!Value2.equals ("")) {
                        sendSMS(phoneNumber2, Message, context);
                    }

                    if (!Value3.equals ("")) {
                        sendSMS(phoneNumber3, Message, context);
                    }
                    if (!Value4.equals ("")) {
                        sendSMS(phoneNumber4, Message, context);
                    }
                }
            }
